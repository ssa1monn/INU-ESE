...
void myName(void) {
    ...
    for (i = 1; i < 8; i++) editPixel(i, 1, 0);
    editPixel(0, 1, 255); editPixel(8, 1, 255);
    for (i = 0; i < 4; i++) editPixel(i, 2, 255);
    editPixel(4, 2, 0);
    for (i = 5; i < 9; i++) editPixel(i, 2, 255);
    ...
    for (i = 9; i < 18; i++) editPixel(i, 2, 255);
    editPixel(12, 2, 255); editPixel(13, 2, 0); editPixel(14, 2, 255);
    for (i = 10; i < 17; i++) editPixel(i, 3, 0);
    editPixel(9, 3, 255); editPixel(17, 3, 255);
    ...
    editPixel(25, 5, 0); editPixel(25, 6, 0); editPixel(25, 7, 0); editPixel(25, 8, 0);
    editPixel(26, 5, 255); editPixel(26, 6, 255); editPixel(26, 7, 255); editPixel(26, 8, 255);
    editPixel(20, 7, 0); editPixel(22, 7, 0);
    editPixel(23, 7, 0); editPixel(24, 7, 0); editPixel(21, 8, 0);
